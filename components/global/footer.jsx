...
const Footer = () => {
  return (
    <div className="w-full bg-green-800 px-6 md:px-60 md:pt-18 pt-12 text-white">
        {/* Top Box */}
        <div className="flex flex-col md:flex-row items-start justify-between md:pb-24 pb-6 gap-10 md:gap-0">
          {/* Left Box */}
          ...
          {/* Right Box */}
          <div className="flex flex-col w-full md:w-auto gap-10"> 
        ...
        <div className="flex items-center justify-between border-t border-green-700 py-10">
            <div className="flex flex-row gap-4">
                <button className="cursor-pointer md:text-2xl text-sm"> <FaFacebook/> </button>
                <button className="cursor-pointer md:text-2xl text-sm"> <FaTwitter/> </button>
                <button className="cursor-pointer md:text-2xl text-sm"> <RiInstagramFill/> </button>
            </div>
            <p className="font-extralight md:text-md text-sm">Copyright ©2022 Neatly Hotel</p>
        </div>
    </div>
  );
};
